<template>
  <div class="mt-10">
    <div class="flex flex-wrap justify-center">
      <!-- List of Erg Sessions -->
      <section>
        <div>
          <div class="flex justify-between mb-2">
            <h1 class="text-3xl text-indigo-700">Erg Sessions</h1>
...
import ErgSessionService from "../services/ErgSessionService";
...
export default {
  setup() {
    ...
    const reloadData = async () => {
      state.sessions = await ErgSessionService.getAll();
    };
    ...
    const deletePressed = async (id) => {
      await ErgSessionService.deleteOne(id);
      state.wellness = await ErgSessionService.getAll();
    };
